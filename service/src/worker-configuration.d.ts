/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: f6d536860615ea3459ec985d88d8099e)
// Runtime types generated with workerd@1.20260611.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	KB_ARTIFACTS: R2Bucket;
	KB_DB: D1Database;
	ISSUE_REPORT_RATE_LIMITER: RateLimit;
	LOADER: WorkerLoader;
	PUBLIC_BASE_URL: "https://rock-agent-kb.oneandall.church";
	GITHUB_OWNER: "ONE-ALL-Church";
	GITHUB_REPO: "rock-agent-kb";
	AUTO_MERGE_INTAKE: "false";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "GITHUB_OWNER" | "GITHUB_REPO" | "AUTO_MERGE_INTAKE">> {}
}
