...
task_id: recipe-create-safe-lava-for-channel-display
title: Recipe: Create safe Lava for channel display
generated: true
---

# Recipe: Create safe Lava for channel display

Follow the guide section for Recipe: Create safe Lava for channel display.
