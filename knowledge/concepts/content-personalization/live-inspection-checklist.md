---
id: live-checklist:content-personalization
concept_id: content-personalization
generated: true
artifact_level: live_checklist
---

# Content And Personalization Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Content And Personalization record, page, block, entity, or configured object named by the user.
