...
# Content And Personalization Live Probe Recipes
...
- Recipe id: `live-probe-recipe:content-personalization:version-and-release-context`
...
- Recipe id: `live-probe-recipe:content-personalization:database-migration-context`
...
- Recipe id: `live-probe-recipe:content-personalization:page-block-settings`
...
- Recipe id: `live-probe-recipe:content-personalization:security-rows`
...
- Recipe id: `live-probe-recipe:content-personalization:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Content And Personalization record, page, block, entity, or configured object named by the user.
