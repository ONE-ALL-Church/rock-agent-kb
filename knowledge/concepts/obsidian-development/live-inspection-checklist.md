---
id: live-checklist:obsidian-development
concept_id: obsidian-development
generated: true
artifact_level: live_checklist
---

# Obsidian Development Live Inspection Checklist
...
10. Inspect `Registration instance and registrant records` in the live instance when the question touches this surface.
...
```
- **Named records**
  - Search the live Rock instance for the exact Obsidian Development record, page, block, entity, or configured object named by the user.
