...
# Obsidian Development Live Probe Recipes
...
- Recipe id: `live-probe-recipe:obsidian-development:version-and-release-context`
...
- Recipe id: `live-probe-recipe:obsidian-development:database-migration-context`
...
- Recipe id: `live-probe-recipe:obsidian-development:page-block-settings`
...
- Recipe id: `live-probe-recipe:obsidian-development:security-rows`
...
- Recipe id: `live-probe-recipe:obsidian-development:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Obsidian Development record, page, block, entity, or configured object named by the user.
