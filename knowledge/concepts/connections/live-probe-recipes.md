...
# Connections Live Probe Recipes
...
- Recipe id: `live-probe-recipe:connections:version-and-release-context`
...
- Recipe id: `live-probe-recipe:connections:database-migration-context`
...
- Recipe id: `live-probe-recipe:connections:page-block-settings`
...
- Recipe id: `live-probe-recipe:connections:security-rows`
...
- Recipe id: `live-probe-recipe:connections:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Connections record, page, block, entity, or configured object named by the user.
