---
id: live-checklist:connections
concept_id: connections
generated: true
artifact_level: live_checklist
---

# Connections Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Connections record, page, block, entity, or configured object named by the user.
