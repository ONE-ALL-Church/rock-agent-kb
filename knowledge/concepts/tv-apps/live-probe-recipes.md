...
- Recipe id: `live-probe-recipe:tv-apps:version-and-release-context`
...
- Recipe id: `live-probe-recipe:tv-apps:database-migration-context`
...
- Recipe id: `live-probe-recipe:tv-apps:page-block-settings`
...
- Recipe id: `live-probe-recipe:tv-apps:security-rows`
...
- Recipe id: `live-probe-recipe:tv-apps:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact TV Apps record, page, block, entity, or configured object named by the user.
