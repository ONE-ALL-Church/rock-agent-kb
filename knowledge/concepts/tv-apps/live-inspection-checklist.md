---
id: live-checklist:tv-apps
concept_id: tv-apps
generated: true
artifact_level: live_checklist
---

# TV Apps Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact TV Apps record, page, block, entity, or configured object named by the user.
