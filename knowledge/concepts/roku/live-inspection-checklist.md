---
id: live-checklist:roku
concept_id: roku
generated: true
artifact_level: live_checklist
---

# Roku Apps Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Roku Apps record, page, block, entity, or configured object named by the user.
