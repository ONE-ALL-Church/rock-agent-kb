...
- Recipe id: `live-probe-recipe:roku:version-and-release-context`
...
- Recipe id: `live-probe-recipe:roku:database-migration-context`
...
- Recipe id: `live-probe-recipe:roku:page-block-settings`
...
- Recipe id: `live-probe-recipe:roku:security-rows`
...
- Recipe id: `live-probe-recipe:roku:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Roku Apps record, page, block, entity, or configured object named by the user.
