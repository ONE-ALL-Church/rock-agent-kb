---
id: live-checklist:learning-lms-engagement
concept_id: learning-lms-engagement
generated: true
artifact_level: live_checklist
---

# Learning, LMS, And Engagement Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Learning, LMS, And Engagement record, page, block, entity, or configured object named by the user.
