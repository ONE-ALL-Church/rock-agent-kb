...
# Learning, LMS, And Engagement Live Probe Recipes
...
- Recipe id: `live-probe-recipe:learning-lms-engagement:version-and-release-context`
...
- Recipe id: `live-probe-recipe:learning-lms-engagement:database-migration-context`
...
- Recipe id: `live-probe-recipe:learning-lms-engagement:page-block-settings`
...
- Recipe id: `live-probe-recipe:learning-lms-engagement:security-rows`
...
- Recipe id: `live-probe-recipe:learning-lms-engagement:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Learning, LMS, And Engagement record, page, block, entity, or configured object named by the user.
