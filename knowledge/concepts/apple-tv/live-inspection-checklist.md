---
id: live-checklist:apple-tv
concept_id: apple-tv
generated: true
artifact_level: live_checklist
---

# Apple TV Apps Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Apple TV Apps record, page, block, entity, or configured object named by the user.
