...
# Apple TV Apps Live Probe Recipes
...
- Recipe id: `live-probe-recipe:apple-tv:version-and-release-context`
...
- Recipe id: `live-probe-recipe:apple-tv:database-migration-context`
...
- Recipe id: `live-probe-recipe:apple-tv:page-block-settings`
...
- Recipe id: `live-probe-recipe:apple-tv:security-rows`
...
- Recipe id: `live-probe-recipe:apple-tv:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Apple TV Apps record, page, block, entity, or configured object named by the user.
