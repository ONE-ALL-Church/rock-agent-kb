---
id: answer:apple-tv:live-inspection
concept_id: apple-tv
generated: true
artifact_level: answer
---

# What live Rock records should I inspect for Apple TV Apps?

For Apple TV Apps, inspect these live surfaces before changing production behavior: Rock version, Block settings, Security roles and permissions, WorkflowType and Workflow records, Mobile shell version and mobile block settings.

## Top Claims

- `claim:04ea8a3340efad3b9001`
...
- [Creating a Sign-in Page](https://community.rockrms.com/developer/apple-tv-docs/building-your-first-app/creating-a-sign-in-page)
