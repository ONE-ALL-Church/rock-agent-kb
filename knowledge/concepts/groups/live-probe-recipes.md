...
- Recipe id: `live-probe-recipe:groups:version-and-release-context`
...
- Recipe id: `live-probe-recipe:groups:database-migration-context`
...
- Recipe id: `live-probe-recipe:groups:page-block-settings`
...
- Recipe id: `live-probe-recipe:groups:security-rows`
...
- Recipe id: `live-probe-recipe:groups:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Groups record, page, block, entity, or configured object named by the user.
