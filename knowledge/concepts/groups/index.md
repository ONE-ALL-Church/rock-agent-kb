...
title: Groups
generated: true
last_built: 2026-09-09T23:37:49+00:00
guide_status: generated_needs_review
rebuild_policy: source_hash_changed_or_weekly
source_count: 80
source_freshness_status: complete
source_last_checked_at: 2026-09-09T21:16:20+00:00
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| [Group Member](../../model-map/models/group-member.md) | Group | 19.3.4 | 64 | 30 | 49 | 19 | 0 | [source](https://community.rockrms.com/ModelMap) |
| [Group Member Assignment](../../model-map/models/group-member-assignment.md) | Group | 19.3.4 | 46 | 15 | 28 | 14 | 0 | [source](https://community.rockrms.com/ModelMap) |
| [Group Member Historical](../../model-map/models/group-member-historical.md) | Group | 19.3.4 | 53 | 22 | 38 | 16 | 0 | [source](https://community.rockrms.com/ModelMap) |
...
| [Group Type](../../model-map/models/group-type.md) | Group | 19.3.4 | 135 | 86 | 113 | 27 | 3 | [source](https://community.rockrms.com/ModelMap) |
...
| [Group](../../model-map/models/group.md) | Group | 19.3.4 | 115 | 61 | 93 | 32 | 6 | [source](https://community.rockrms.com/ModelMap) |
| [Group Demographic Type](../../model-map/models/group-demographic-type.md) | Group | 19.3.4 | 46 | 17 | 31 | 14 | 0 | [source](https://community.rockrms.com/ModelMap) |
| [Group Demographic Value](../../model-map/models/group-demographic-value.md) | Group | 19.3.4 | 48 | 18 | 33 | 15 | 0 | [source](https://community.rockrms.com/ModelMap) |
| [Group Historical](../../model-map/models/group-historical.md) | Group | 19.3.4 | 61 | 28 | 46 | 18 | 0 | [source](https://community.rockrms.com/ModelMap) |
...
- `Group.ArchivedByPersonAlias` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.AttributeValues` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.Attributes` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.Campus` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.ChatChannelAvatarBinaryFile` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.CreatedByPersonId` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.CreatedByPersonName` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
- `Group.EntityStringValue` is Lava-marked but not database-marked in the generated Model Map (Rock 19.3.4; source https://rocksolidchurchdemo.com/admin/power-tools/model-map).
...
- Upstream check range: `2026-09-09T21:16:15+00:00` through `2026-09-09T21:16:20+00:00`
