---
id: live-checklist:groups
concept_id: groups
generated: true
artifact_level: live_checklist
---

# Groups Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Groups record, page, block, entity, or configured object named by the user.
