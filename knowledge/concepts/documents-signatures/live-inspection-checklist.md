---
id: live-checklist:documents-signatures
concept_id: documents-signatures
generated: true
artifact_level: live_checklist
---

# Documents And Signatures Live Inspection Checklist
...
9. Inspect `Communication recipient, medium, and send history` in the live instance when the question touches this surface.
...
```
- **Named records**
  - Search the live Rock instance for the exact Documents And Signatures record, page, block, entity, or configured object named by the user.
