---
id: live-checklist:system-admin-ops
concept_id: system-admin-ops
generated: true
artifact_level: live_checklist
---

# System Administration And Operations Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact System Administration And Operations record, page, block, entity, or configured object named by the user.
