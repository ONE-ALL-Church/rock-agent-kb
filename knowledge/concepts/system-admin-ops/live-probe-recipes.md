...
# System Administration And Operations Live Probe Recipes
...
- Recipe id: `live-probe-recipe:system-admin-ops:version-and-release-context`
...
- Recipe id: `live-probe-recipe:system-admin-ops:database-migration-context`
...
- Recipe id: `live-probe-recipe:system-admin-ops:page-block-settings`
...
- Recipe id: `live-probe-recipe:system-admin-ops:security-rows`
...
- Recipe id: `live-probe-recipe:system-admin-ops:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact System Administration And Operations record, page, block, entity, or configured object named by the user.
