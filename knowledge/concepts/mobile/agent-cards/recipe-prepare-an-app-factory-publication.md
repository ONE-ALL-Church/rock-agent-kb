---
concept_id: mobile
task_id: recipe-prepare-an-app-factory-publication
title: Recipe: Prepare an App Factory publication
generated: true
---

# Recipe: Prepare an App Factory publication

The publishing provider has a reviewable, secure and complete submission package.
