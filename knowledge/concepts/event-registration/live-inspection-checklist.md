---
id: live-checklist:event-registration
concept_id: event-registration
generated: true
artifact_level: live_checklist
---

# Event Registration Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Event Registration record, page, block, entity, or configured object named by the user.
