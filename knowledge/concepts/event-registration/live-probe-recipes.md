...
# Event Registration Live Probe Recipes
...
- Recipe id: `live-probe-recipe:event-registration:version-and-release-context`
...
- Recipe id: `live-probe-recipe:event-registration:database-migration-context`
...
- Recipe id: `live-probe-recipe:event-registration:page-block-settings`
...
- Recipe id: `live-probe-recipe:event-registration:security-rows`
...
- Recipe id: `live-probe-recipe:event-registration:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Event Registration record, page, block, entity, or configured object named by the user.
