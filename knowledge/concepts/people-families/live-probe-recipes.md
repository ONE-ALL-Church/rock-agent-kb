...
# People And Families Live Probe Recipes
...
- Recipe id: `live-probe-recipe:people-families:version-and-release-context`
...
- Recipe id: `live-probe-recipe:people-families:database-migration-context`
...
- Recipe id: `live-probe-recipe:people-families:page-block-settings`
...
- Recipe id: `live-probe-recipe:people-families:security-rows`
...
- Recipe id: `live-probe-recipe:people-families:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact People And Families record, page, block, entity, or configured object named by the user.
