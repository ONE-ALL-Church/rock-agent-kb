---
id: live-checklist:people-families
concept_id: people-families
generated: true
artifact_level: live_checklist
---

# People And Families Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact People And Families record, page, block, entity, or configured object named by the user.
