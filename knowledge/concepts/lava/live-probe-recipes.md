...
- Recipe id: `live-probe-recipe:lava:version-and-release-context`
...
- Recipe id: `live-probe-recipe:lava:database-migration-context`
...
- Recipe id: `live-probe-recipe:lava:page-block-settings`
...
- Recipe id: `live-probe-recipe:lava:security-rows`
...
- Recipe id: `live-probe-recipe:lava:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Lava record, page, block, entity, or configured object named by the user.
