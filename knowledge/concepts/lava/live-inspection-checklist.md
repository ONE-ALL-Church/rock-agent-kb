---
id: live-checklist:lava
concept_id: lava
generated: true
artifact_level: live_checklist
---

# Lava Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Lava record, page, block, entity, or configured object named by the user.
