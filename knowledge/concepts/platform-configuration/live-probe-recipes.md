...
# Platform Configuration Live Probe Recipes
...
- Recipe id: `live-probe-recipe:platform-configuration:version-and-release-context`
...
- Recipe id: `live-probe-recipe:platform-configuration:database-migration-context`
...
- Recipe id: `live-probe-recipe:platform-configuration:page-block-settings`
...
- Recipe id: `live-probe-recipe:platform-configuration:security-rows`
...
- Recipe id: `live-probe-recipe:platform-configuration:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Platform Configuration record, page, block, entity, or configured object named by the user.
