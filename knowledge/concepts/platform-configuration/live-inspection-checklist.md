---
id: live-checklist:platform-configuration
concept_id: platform-configuration
generated: true
artifact_level: live_checklist
---

# Platform Configuration Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Platform Configuration record, page, block, entity, or configured object named by the user.
