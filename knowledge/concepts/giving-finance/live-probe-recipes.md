...
# Giving And Finance Live Probe Recipes
...
- Recipe id: `live-probe-recipe:giving-finance:version-and-release-context`
...
- Recipe id: `live-probe-recipe:giving-finance:database-migration-context`
...
- Recipe id: `live-probe-recipe:giving-finance:page-block-settings`
...
- Recipe id: `live-probe-recipe:giving-finance:security-rows`
...
- Recipe id: `live-probe-recipe:giving-finance:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Giving And Finance record, page, block, entity, or configured object named by the user.
