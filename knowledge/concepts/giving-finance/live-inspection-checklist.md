---
id: live-checklist:giving-finance
concept_id: giving-finance
generated: true
artifact_level: live_checklist
---

# Giving And Finance Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Giving And Finance record, page, block, entity, or configured object named by the user.
