...
# Serving And Volunteer Operations Live Probe Recipes
...
- Recipe id: `live-probe-recipe:serving-volunteer-ops:version-and-release-context`
...
- Recipe id: `live-probe-recipe:serving-volunteer-ops:database-migration-context`
...
- Recipe id: `live-probe-recipe:serving-volunteer-ops:page-block-settings`
...
- Recipe id: `live-probe-recipe:serving-volunteer-ops:security-rows`
...
- Recipe id: `live-probe-recipe:serving-volunteer-ops:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Serving And Volunteer Operations record, page, block, entity, or configured object named by the user.
