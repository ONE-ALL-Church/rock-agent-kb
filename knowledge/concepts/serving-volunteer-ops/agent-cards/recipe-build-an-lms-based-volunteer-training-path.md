...
task_id: recipe-build-an-lms-based-volunteer-training-path
title: Recipe: Build an LMS-based volunteer training path
generated: true
---

# Recipe: Build an LMS-based volunteer training path

A volunteer completes defined learning activities and reaches an explicitly reviewed operational result.
