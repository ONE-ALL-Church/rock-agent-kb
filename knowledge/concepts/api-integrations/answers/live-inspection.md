---
id: answer:api-integrations:live-inspection
concept_id: api-integrations
generated: true
artifact_level: answer
---

# What live Rock records should I inspect for API And Integrations?

For API And Integrations, inspect these live surfaces before changing production behavior: Rock version, Block settings, Security roles and permissions, WorkflowType and Workflow records, DataView and report filters, Mobile shell version and mobile block settings, Person, family, alias, and attribute records.
...
- [Ladies and Gentlemen, Your RX26 Keynote Speaker | Ep 216](https://www.youtube.com/watch?v=mYTaGxYMyyQ&t=557s) (`09:17`)
