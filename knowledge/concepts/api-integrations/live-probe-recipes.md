...
# API And Integrations Live Probe Recipes
...
- Recipe id: `live-probe-recipe:api-integrations:version-and-release-context`
...
- Recipe id: `live-probe-recipe:api-integrations:database-migration-context`
...
- Recipe id: `live-probe-recipe:api-integrations:page-block-settings`
...
- Recipe id: `live-probe-recipe:api-integrations:security-rows`
...
- Recipe id: `live-probe-recipe:api-integrations:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact API And Integrations record, page, block, entity, or configured object named by the user.
