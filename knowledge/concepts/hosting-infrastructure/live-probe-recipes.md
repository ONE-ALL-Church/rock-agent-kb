...
# Hosting And Infrastructure Live Probe Recipes
...
- Recipe id: `live-probe-recipe:hosting-infrastructure:version-and-release-context`
...
- Recipe id: `live-probe-recipe:hosting-infrastructure:database-migration-context`
...
- Recipe id: `live-probe-recipe:hosting-infrastructure:page-block-settings`
...
- Recipe id: `live-probe-recipe:hosting-infrastructure:security-rows`
...
- Recipe id: `live-probe-recipe:hosting-infrastructure:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Hosting And Infrastructure record, page, block, entity, or configured object named by the user.
