---
id: live-checklist:hosting-infrastructure
concept_id: hosting-infrastructure
generated: true
artifact_level: live_checklist
---

# Hosting And Infrastructure Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Hosting And Infrastructure record, page, block, entity, or configured object named by the user.
