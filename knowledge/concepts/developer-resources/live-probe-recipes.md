...
# Rock Developer Resources Live Probe Recipes
...
- Recipe id: `live-probe-recipe:developer-resources:version-and-release-context`
...
- Recipe id: `live-probe-recipe:developer-resources:database-migration-context`
...
- Recipe id: `live-probe-recipe:developer-resources:page-block-settings`
...
- Recipe id: `live-probe-recipe:developer-resources:security-rows`
...
- Recipe id: `live-probe-recipe:developer-resources:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Rock Developer Resources record, page, block, entity, or configured object named by the user.
