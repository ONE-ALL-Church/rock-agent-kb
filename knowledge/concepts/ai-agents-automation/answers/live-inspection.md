...
For AI Agents And Automation, inspect these live surfaces before changing production behavior: Rock version, Block settings, Security roles and permissions, WorkflowType and Workflow records, DataView and report filters, Financial transaction and gateway settings, Person, family, alias, and attribute records.
