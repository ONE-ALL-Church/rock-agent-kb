---
id: answer:ai-agents-automation:live-inspection
concept_id: ai-agents-automation
generated: true
artifact_level: answer
---

# What live Rock records should I inspect for AI Agents And Automation?

For AI Agents And Automation, inspect these live surfaces before changing production behavior: Rock version, Block settings, Security roles and permissions, WorkflowType and Workflow records, DataView and report filters, Financial transaction and gateway settings, Mobile shell version and mobile block settings, Person, family, alias, and attribute records.
