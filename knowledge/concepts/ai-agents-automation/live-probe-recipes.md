...
# AI Agents And Automation Live Probe Recipes
...
- Recipe id: `live-probe-recipe:ai-agents-automation:version-and-release-context`
...
- Recipe id: `live-probe-recipe:ai-agents-automation:database-migration-context`
...
- Recipe id: `live-probe-recipe:ai-agents-automation:page-block-settings`
...
- Recipe id: `live-probe-recipe:ai-agents-automation:security-rows`
...
- Recipe id: `live-probe-recipe:ai-agents-automation:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact AI Agents And Automation record, page, block, entity, or configured object named by the user.
