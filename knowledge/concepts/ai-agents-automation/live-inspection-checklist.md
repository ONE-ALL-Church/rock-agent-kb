---
id: live-checklist:ai-agents-automation
concept_id: ai-agents-automation
generated: true
artifact_level: live_checklist
---

# AI Agents And Automation Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact AI Agents And Automation record, page, block, entity, or configured object named by the user.
