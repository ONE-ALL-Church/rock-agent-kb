...
# Communications Live Probe Recipes
...
- Recipe id: `live-probe-recipe:communications:version-and-release-context`
...
- Recipe id: `live-probe-recipe:communications:database-migration-context`
...
- Recipe id: `live-probe-recipe:communications:page-block-settings`
...
- Recipe id: `live-probe-recipe:communications:security-rows`
...
- Recipe id: `live-probe-recipe:communications:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Communications record, page, block, entity, or configured object named by the user.
