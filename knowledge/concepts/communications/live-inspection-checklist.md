---
id: live-checklist:communications
concept_id: communications
generated: true
artifact_level: live_checklist
---

# Communications Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Communications record, page, block, entity, or configured object named by the user.
