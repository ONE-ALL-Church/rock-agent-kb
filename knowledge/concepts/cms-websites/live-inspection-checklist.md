---
id: live-checklist:cms-websites
concept_id: cms-websites
generated: true
artifact_level: live_checklist
---

# CMS And Websites Live Inspection Checklist
...
10. Inspect `Mobile shell version and mobile block settings` in the live instance when the question touches this surface.
...
```
- **Named records**
  - Search the live Rock instance for the exact CMS And Websites record, page, block, entity, or configured object named by the user.
