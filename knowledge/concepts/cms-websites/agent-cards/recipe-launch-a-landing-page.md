...
task_id: recipe-launch-a-landing-page
title: Recipe: Launch a landing page
generated: true
---

# Recipe: Launch a landing page

A campaign page has the intended route, content, call to action, metadata, and retirement plan.
...
9. Define the end date, redirect, archival behavior, or removal procedure before launch.
...
- https://community.rockrms.com/documentation/digital-publishing/websites/html-content-block/configure-block-settings
