...
# CMS And Websites Live Probe Recipes
...
- Recipe id: `live-probe-recipe:cms-websites:version-and-release-context`
...
- Recipe id: `live-probe-recipe:cms-websites:database-migration-context`
...
- Recipe id: `live-probe-recipe:cms-websites:page-block-settings`
...
- Recipe id: `live-probe-recipe:cms-websites:security-rows`
...
- Recipe id: `live-probe-recipe:cms-websites:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact CMS And Websites record, page, block, entity, or configured object named by the user.
