---
id: live-checklist:prayer-care
concept_id: prayer-care
generated: true
artifact_level: live_checklist
---

# Prayer And Care Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Prayer And Care record, page, block, entity, or configured object named by the user.
