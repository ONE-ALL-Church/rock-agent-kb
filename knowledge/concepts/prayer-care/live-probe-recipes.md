...
# Prayer And Care Live Probe Recipes
...
- Recipe id: `live-probe-recipe:prayer-care:version-and-release-context`
...
- Recipe id: `live-probe-recipe:prayer-care:database-migration-context`
...
- Recipe id: `live-probe-recipe:prayer-care:page-block-settings`
...
- Recipe id: `live-probe-recipe:prayer-care:security-rows`
...
- Recipe id: `live-probe-recipe:prayer-care:named-records`
- Target binding: This is a manual inspection recipe; bind it to the exact page, block, workflow, report, mobile screen, or configured object named by the user.

Manual check: Search the live Rock instance for the exact Prayer And Care record, page, block, entity, or configured object named by the user.
