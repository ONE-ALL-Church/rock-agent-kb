---
id: live-checklist:helix
concept_id: helix
generated: true
artifact_level: live_checklist
---

# Helix Live Inspection Checklist
...
```
- **Named records**
  - Search the live Rock instance for the exact Helix record, page, block, entity, or configured object named by the user.
