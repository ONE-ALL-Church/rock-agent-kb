...
| --- | --- | --- | --- | --- | --- | --- |
| AIProviderAttributeValues |  |  | yes |  |  | Gets the entity attribute values. This should only be used inside LINQ statements when building a where clause for the query. This property should only be used inside LINQ statements for filtering or selecting values. Do not use it for accessing the attributes after the entity has been loaded. |
...
| ProviderComponentEntityType |  | yes | yes |  |  | Gets or sets the type of the entity. |
| ProviderComponentEntityTypeId | yes | yes |  |  |  | Gets or sets the entity type identifier. |
...
| ProviderComponentEntityType | Gets or sets the type of the entity. |
| TypeId |  |
| TypeName |  |
| UrlEncodedKey |  |
