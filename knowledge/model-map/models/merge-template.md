...
| IsValid |  |  | yes |  |  |  |
| Item |  |  | yes |  |  |  |
| MergeTemplateAttributeValues |  |  | yes |  |  | Gets the entity attribute values. This should only be used inside LINQ statements when building a where clause for the query. This property should only be used inside LINQ statements for filtering or selecting values. Do not use it for accessing the attributes after the entity has been loaded. |
| MergeTemplateTypeEntityType |  | yes | yes |  |  | Gets or sets the type of the merge template type entity. |
| MergeTemplateTypeEntityTypeId | yes | yes |  |  |  | Gets or sets the merge template type entity type identifier. |
...
| TemplateBinaryFile |  | yes | yes |  |  | Gets or sets the template binary file. |
| TemplateBinaryFileId | yes | yes |  |  |  | Gets or sets the template binary file identifier. |
| TypeId |  | yes | yes |  |  |  |
| TypeName |  | yes | yes |  |  |  |
...
| EntityStringValue |  |
| IdKey |  |
| MergeTemplateTypeEntityType | Gets or sets the type of the merge template type entity. |
| ModifiedAuditValuesAlreadyUpdated |  |
| ModifiedByPersonId |  |
| ModifiedByPersonName |  |
| PersonAlias | Gets or sets the person alias. |
| TemplateBinaryFile | Gets or sets the template binary file. |
| TypeId |  |
| TypeName |  |
| UrlEncodedKey |  |
