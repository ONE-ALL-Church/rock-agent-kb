...
| Id | yes | yes |  |  |  |  |
| IdKey |  | yes | yes |  |  |  |
| IsActive | yes | yes |  |  |  | Gets or sets a value indicating whether this Snippet is active. |
| IsValid |  |  | yes |  |  |  |
| Item |  |  | yes |  |  |  |
...
| SnippetType |  | yes | yes |  |  | Gets or sets the type of the snippet. |
| SnippetTypeId | yes | yes |  |  |  | Gets or sets the snippet type identifier. |
