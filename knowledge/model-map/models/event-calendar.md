...
| Attributes |  | yes | yes |  |  |  |
| AvailableKeys |  |  | yes |  |  |  |
| ContentChannels |  |  | yes |  |  | Gets or sets the content channels. |
| ContextKey |  |  | yes |  |  |  |
...
| CustomSortValue |  |  | yes |  |  |  |
| Description | yes | yes |  |  |  | Gets or sets the Description of the EventCalendar. |
| EncryptedKey |  |  | yes |  |  |  |
| EntityStringValue |  | yes | yes |  |  |  |
| EventCalendarAttributeValues |  |  | yes |  |  | Gets the entity attribute values. This should only be used inside LINQ statements when building a where clause for the query. This property should only be used inside LINQ statements for filtering or selecting values. Do not use it for accessing the attributes after the entity has been loaded. |
| EventCalendarItems |  |  | yes |  |  | Gets or sets the event calendar items. |
| ForeignGuid | yes | yes |  |  |  |  |
| ForeignId | yes | yes |  |  |  |  |
| ForeignKey | yes | yes |  |  |  |  |
| Guid | yes | yes |  |  |  |  |
...
| Name | yes | yes |  | yes |  | Gets or sets the Name of the EventCalendar. This property is required. |
| ParentAuthority |  |  | yes |  |  |  |
