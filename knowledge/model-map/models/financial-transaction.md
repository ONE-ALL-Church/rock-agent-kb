...
| AvailableKeys |  |  | yes |  |  |  |
| Batch |  | yes | yes |  |  | Gets or sets the FinancialBatch that contains the transaction. |
| BatchHistoryChangeList |  |  | yes |  |  | [Obsoleted in v14] Does nothing. No longer needed. We replaced this with a private property under the SaveHook class for this entity. Gets or sets the batch history change list. |
| BatchId | yes | yes |  |  |  | Gets or sets BatchId of the FinancialBatch that contains this transaction. |
...
| NonCashAssetTypeValue |  | yes | yes |  |  | Gets or sets the non cash asset type DefinedValue. |
| NonCashAssetTypeValueId | yes | yes |  |  |  | Gets or sets the non cash asset type DefinedValue identifier. These are found in the "Non-Cash Asset Types" Defined Type. |
| ParentAuthority |  |  | yes |  |  |  |
| ParentAuthorityPre |  |  | yes |  |  |  |
| ProcessedByPersonAlias |  | yes | yes |  |  | Gets or sets the PersonAlias of the PersonAlias who processed the transaction. For example, if the transaction is from a scanned check, the ProcessedByPersonAlias is the person who matched (or started to match) the check to the person who wrote the check. |
| ProcessedByPersonAliasId | yes |  |  |  |  | Gets or sets the PersonAliasId of the PersonAlias who processed the transaction. For example, if the transaction is from a scanned check, the ProcessedByPersonAlias is the person who matched (or started to match) the check to the person who wrote the check. |
...
| ScheduledTransactionId | yes | yes |  |  |  | Gets or sets the ScheduledTransactionId of the FinancialScheduledTransaction that triggered this transaction. If this was an ad-hoc/on demand transaction, this property will be null. |
...
| SourceTypeValueId | yes | yes |  |  |  | Gets or sets the DefinedValueId of the source type DefinedValue for this transaction. Representing the source (method) of this transaction. These are found in the "Transaction Source" Defined Type. |
...
| TransactionTypeValueId | yes | yes |  |  |  | Gets or sets the DefinedValueId of the TransactionType DefinedValue indicating the type of the transaction. These are found in the "Transaction Type" Defined Type. |
| TypeId |  | yes | yes |  |  |  |
| TypeName |  | yes | yes |  |  |  |
...
| Batch | [FinancialBatch](financial-batch.md) |  |
| BatchId | [FinancialBatch](financial-batch.md) |  |
| FinancialGateway | gateway |  |
| FinancialPaymentDetail | [FinancialPaymentDetail](financial-payment-detail.md) |  |
| Images | images |  |
| NonCashAssetTypeValue | [DefinedValue](defined-value.md) |  |
| NonCashAssetTypeValueId | [DefinedValue](defined-value.md) |  |
| ProcessedByPersonAlias | [PersonAlias](person-alias.md) |  |
| ProcessedByPersonAliasId | [PersonAlias](person-alias.md) |  |
| RefundDetails | refund |  |
| ScheduledTransaction | Scheduled Transaction |  |
