...
| ApiId | yes | yes |  |  |  | Gets or sets the api identifier. |
...
| ContextKey |  |  | yes |  |  |  |
| Controller |  | yes | yes |  |  | Gets or sets the controller. |
| ControllerId | yes | yes |  | yes |  | Gets or sets the controller identifier. |
...
| IsValid |  |  | yes |  |  |  |
| Item |  |  | yes |  |  |  |
| Method | yes | yes |  |  |  | Gets or sets the method. |
...
| Path | yes | yes |  |  |  | Gets or sets the path. |
| RestActionAttributeValues |  |  | yes |  |  | Gets the entity attribute values. This should only be used inside LINQ statements when building a where clause for the query. This property should only be used inside LINQ statements for filtering or selecting values. Do not use it for accessing the attributes after the entity has been loaded. |
