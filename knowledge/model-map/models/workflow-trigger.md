...
| EntityType |  | yes | yes |  |  | Gets or sets the EntityType that contains the entities that are affected by this WorkflowTrigger. |
| EntityTypeId | yes | yes |  | yes |  | Gets or sets the EntityTypeId of the EntityType of the entities that this trigger applies to |
...
| --- | --- |
| EntityStringValue |  |
| EntityType | Gets or sets the EntityType that contains the entities that are affected by this WorkflowTrigger. |
| IdKey |  |
| TypeId |  |
| TypeName |  |
| UrlEncodedKey |  |
