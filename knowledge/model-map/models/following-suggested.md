# Following Suggested Model Detail
...
| FollowingSuggestedAttributeValues |  |  | yes |  |  | Gets the entity attribute values. This should only be used inside LINQ statements when building a where clause for the query. This property should only be used inside LINQ statements for filtering or selecting values. Do not use it for accessing the attributes after the entity has been loaded. |
| ForeignGuid | yes | yes |  |  |  |  |
| ForeignId | yes | yes |  |  |  |  |
| ForeignKey | yes | yes |  |  |  |  |
| Guid | yes | yes |  |  |  |  |
...
| IsValid |  |  | yes |  |  |  |
| Item |  |  | yes |  |  |  |
| LastPromotedDateTime | yes | yes |  |  |  | Gets or sets the last promoted date time. |
...
| StatusChangedDateTime | yes | yes |  |  |  | Gets or sets the status changed date time. |
| SuggestionType |  | yes | yes |  |  | Gets or sets the type of the suggestion. |
| SuggestionTypeId | yes | yes |  |  |  | Gets or sets the suggestion type identifier. |
...
| SuggestionType | Gets or sets the type of the suggestion. |
| TypeId |  |
| TypeName |  |
| UrlEncodedKey |  |
