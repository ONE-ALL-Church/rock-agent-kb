# Metric Category Model Detail

- Track: `stable`
- Rock version: `19.1.8`
- Category: `Reporting`
- Model title: `MetricCategory`
- EntityType GUID: `3d35c859-df37-433f-a20a-0ffd0fcb9862`
...
| ForeignKey | yes | yes |  |  |  |  |
| Guid | yes | yes |  |  |  |  |
| IconCssClass |  |  | yes |  |  | Gets the icon CSS class. |
| Id | yes | yes |  |  |  |  |
| IdKey |  | yes | yes |  |  |  |
| IsValid |  |  | yes |  |  |  |
| Item |  |  | yes |  |  |  |
| Metric |  | yes | yes |  |  | Gets or sets the metric. |
| MetricId | yes | yes |  |  |  | Gets or sets the metric identifier. |
| Name |  |  | yes |  |  | Gets or sets the name. |
