...
| Attributes |  | yes | yes |  |  |  |
| AvailableKeys |  |  | yes |  |  |  |
| Content | yes | yes |  |  |  | Gets or sets the content of the tab. |
| ContextKey |  |  | yes |  |  |  |
...
| StartDateTime | yes | yes |  |  |  | Gets or sets the date the content tab becomes visible to students. |
| SupportedActions |  |  | yes |  |  |  |
| Title | yes | yes |  | yes |  | Gets or sets the title of the content tab. |
| TypeId |  | yes | yes |  |  |  |
| TypeName |  | yes | yes |  |  |  |
