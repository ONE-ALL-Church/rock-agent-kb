...
| ParentAuthority |  |  | yes |  |  | Gets the securable object that security permissions should be inherited from. If block is located on a page security will be inherited from the page, otherwise it will be inherited from the site. |
