...
| --- | --- | --- | --- | --- | --- | --- |
| AIAgent |  |  | yes |  |  | The agent that the skill is associated with. |
| AIAgentId | yes | yes |  | yes |  | The identifier of the agent that the skill is associated with. |
| AISkill |  |  | yes |  |  | The skill that the agent is associated with. |
| AISkillId | yes | yes |  | yes |  | The identifier of the skill that the agent is associated with. |
