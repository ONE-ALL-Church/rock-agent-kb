...
- `routing_context_only`: The claim helps route an agent to a source, concept, or training page. It can appear in indexes and dependency records, but should not drive answer prose.
