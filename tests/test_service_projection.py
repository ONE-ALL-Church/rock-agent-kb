...
def test_build_service_projection_writes_d1_seed_and_artifacts(tmp_path):
    ...
    assert skill_manifest["skill_version"] == "1.12.1"
...
def test_build_d1_seed_sql_records_issue_projection_content_hashes():
    ...
    sql = build_d1_seed_sql(
        ...
        rock_issue_summary={
            ...
            "source_content_hashes": {
                "rock_core_issues": core_hash,
                "rock_mobile_issues": mobile_hash,
            },
            "source_content_hash_algorithms": {
                "rock_core_issues": "rock-kb-issue-source-set-v1",
                "rock_mobile_issues": "rock-kb-issue-source-set-v1",
            },
            "last_checked_at": "2026-08-10T19:00:00Z",
            "projection_checked_at": "2026-08-10T18:00:00Z",
        },
    )
    ...
    assert "rock_issue_source_content_hash_algorithms" in sql
    assert "rock-kb-issue-source-set-v1" in sql
    assert "rock_issue_last_checked_at', '2026-08-10T18:00:00Z" in sql
...
def test_build_d1_seed_sql_records_idea_projection_content_hashes():
    ...
    sql = build_d1_seed_sql(
        ...
        rock_idea_summary={
            ...
            "source_content_hash_algorithm": "rock-kb-normalized-source-set-v1",
            "last_checked_at": "2026-08-10T18:00:00Z",
        },
    )
    ...
    assert "rock_idea_source_content_hash_algorithm', 'rock-kb-normalized-source-set-v1" in sql
    assert "rock_idea_last_checked_at', '2026-08-10T18:00:00Z" in sql
